...
import { SimpleGitHubPipelineStack } from "../lib/simple-github-pipeline";
...
// GitHub CI 파이프라인 스택 (CodeCommit 서비스 중단으로 GitHub 사용)
const githubPipelineStack = new SimpleGitHubPipelineStack(app, "EcsFastScaling-GitHub-Pipeline", {
  env,
  description: "GitHub + CodeBuild CI pipeline",
});
